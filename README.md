...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
      These databases have relations between tables and SQL is a query language we use to get the data from the tables we want.
...
- [ ] What do we need in order to have a _many to many_ relationship between two tables.
      a third table, and index table with 2 foreign keys that connect 2 tables
